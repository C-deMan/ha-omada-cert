...
def reboot_omada_controller(session, base_urls, token, omadac_id):
    ...
    logger.warning("Reboot command sent to available OpenAPI endpoints. (If hardware OC200/OC300 requires manual restart or scheduled reboot, please check controller interface).")
    return True
